...
features/expense/components/ExpenseAmountInputView.tsx
features/expense/hooks/useExpenseAmountInput.ts
```

`*View.tsx` は表示とユーザー操作のprops受け取りに寄せる。TanStack Query、API DTO、Supabase Clientを直接importしない。
