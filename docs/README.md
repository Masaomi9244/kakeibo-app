...
2. `standards/implementation-quality-gates.md`
3. `product/overview.md`
4. `product/scope.md`
5. デザイン実装前は `design/*.md`
6. 該当する `features/*.md`
7. 該当する `api/*.md`
8. 該当する `db/*.md`
9. 該当する `architecture/*.md`
10. 該当する `standards/**/*.md`
...
16. `standards/implementation-quality-gates.md`
17. `standards/common.md`
18. `standards/front-end/*.md`
19. `standards/back-end/*.md`
20. `standards/db/*.md`
...
実装前に確認する横断的な保守性ゲートは `standards/implementation-quality-gates.md` に置きます。

### `tools/`

開発やAIエージェント利用を補助するツールの導入状態、使い方、注意点を置きます。

プロダクト仕様や実装規約の正ではありません。ツール利用時の補助資料として使います。
